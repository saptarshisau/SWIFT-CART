...
function Profile() {
    ...
    return (
        <>
            ...
            {loading ? (<Loader />) : (<div>
                <Navbar />
                <div className="max-w-[800px] my-[1.5rem] md:my-[3rem] mx-[1.5rem] md:mx-auto p-[1.5rem] md:p-[2rem] rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                    ...
                    <div className="text-center bg-gradient-to-br from-[#f6f8ff] to-[#ffffff] rounded-[15px] mb-[2.5rem] pb-8">
                        ...
                        <h1 className="inline-block text-[2rem] md:text-[2.5rem] text-[#3B3B4F] mt-[2rem] mb-[1rem] font-semibold tracking-[-0.5px]">My Profile</h1>
                        ...
                        <Link to="/profile/update" className="inline-block py-[0.75rem] px-[2rem] bg-[#5C4A6F] text-white rounded-[30px] no-underline font-medium transition-all duration-300 ease-in-out shadow-[0_4px_12px_#3B3B4F] hover:bg-[#4E4A59] hover:-translate-y-[2px]">Edit Profile</Link>
                    </div>
                    ...
                    <div className="p-[1.5rem] bg-[#f8fafc] rounded-[15px] my-[2rem]">
                        ...
                        <div className="flex flex-col items-start text-left md:flex-row md:items-center p-[1.25rem] mb-[1rem] bg-white rounded-[12px] transition-all duration-300 ease-in-out shadow-[0_2px_8px_rgba(0,0,0,0.02)] hover:translate-x-[5px] hover:shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
                            ...
                            <p className="text-[1.1rem] text-[#2E2E3C] m-0 pl-0 md:pl-[1rem] font-medium">{user.name}</p>
                        </div>

                        <div className="flex flex-col items-start text-left md:flex-row md:items-center p-[1.25rem] mb-[1rem] bg-white rounded-[12px] transition-all duration-300 ease-in-out shadow-[0_2px_8px_rgba(0,0,0,0.02)] hover:translate-x-[5px] hover:shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
                            <h2 className="text-[1.1rem] text-[#64748b] min-w-[130px] m-0 mb-[0.5rem] md:mb-0 font-medium">Email:</h2>
                            <p className="text-[1.1rem] text-[#2E2E3C] m-0 pl-0 md:pl-[1rem] font-medium">{user.email}</p>
                        </div>

                        <div className="flex flex-col items-start text-left md:flex-row md:items-center p-[1.25rem] mb-[1rem] bg-white rounded-[12px] transition-all duration-300 ease-in-out shadow-[0_2px_8px_rgba(0,0,0,0.02)] hover:translate-x-[5px] hover:shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
                            <h2 className="text-[1.1rem] text-[#64748b] min-w-[130px] m-0 mb-[0.5rem] md:mb-0 font-medium">Joined On:</h2>
                            <p className="text-[1.1rem] text-[#2E2E3C] m-0 pl-0 md:pl-[1rem] font-medium">{user.createdAt ? String(user.createdAt).substring(0, 10) : 'N/A'}</p>
                        </div>

                    </div>
                    <div className="flex flex-col md:flex-row justify-center items-center gap-5 mt-12 w-full px-6">
                        <Link
                            to="/orders/user"
                            className="
