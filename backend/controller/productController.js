...
//http://localhost:8000/api/v1/products?keyword=shirt
...
export const getAllProducts = handleAsyncError(async (req, res, next) => {
  ...
  // cosnt products = await Product.find();
...
export const createReviewForProduct = handleAsyncError(
  async (req, res, next) => {
    ...
    //user.id gives the id of the logged in user not from the review object
    //user._id 
    if (reviewExists) {
